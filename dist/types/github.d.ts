 ...
 */
export declare const REQUIRED_SCOPES: readonly ["repo", "read:org", "workflow"];
export type GitHubScope = (typeof REQUIRED_SCOPES)[number];
/**
 * All possible GitHub token scopes
 */
export type AllGitHubScope = 'repo' | 'repo:status' | 'repo_deployment' | 'public_repo' | 'repo:invite' | 'security_events' | 'read:org' | 'write:org' | 'admin:org' | 'read:public_key' | 'write:public_key' | 'admin:public_key' | 'read:repo_hook' | 'write:repo_hook' | 'admin:repo_hook' | 'read:org_hook' | 'write:org_hook' | 'admin:org_hook' | 'gist' | 'notifications' | 'user' | 'read:user' | 'user:email' | 'user:follow' | 'delete_repo' | 'write:discussion' | 'read:discussion' | 'workflow' | 'write:packages' | 'read:packages' | 'delete:packages' | 'admin:gpg_key' | 'write:gpg_key' | 'read:gpg_key' | 'codespace' | 'copilot' | 'project';
/**
