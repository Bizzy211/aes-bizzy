 ...
 */
export function buildTokenGenerationUrl(scopes = [...REQUIRED_SCOPES]) {
 ...
 */
export async function getGitHubCLIToken() {
    try {
 ...
 */
export async function storeGitHubToken(token) {
    try {
 ...
 */
async function handlePATAuthentication() {
 ...
 */
async function handleGenerateToken(additionalScopes = []) {
