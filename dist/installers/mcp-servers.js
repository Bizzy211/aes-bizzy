 ...
 */
export function checkEnvVars(serverId) {
 ...
 */
export async function isMCPServerInstalled(serverId) {
    const config = getMCPServerConfig(serverId);
    if (!config) {
        return {
            serverId,
 ...
 */
export function buildEnvArgs(serverId, customEnvVars) {
    const config = getMCPServerConfig(serverId);
    if (!config)
        return [];
    const envArgs = [];
 ...
 */
export function resolveHeaderValue(template, customEnvVars) {
 ...
 */
export function buildHttpHeaderArgs(headers, customEnvVars) {
    const headerArgs = [];
 ...
 */
export function buildInstallArgs(config, customEnvVars) {
 ...
 */
export async function installMCPServer(serverId, options = {}) {
 ...
 */
export async function uninstallMCPServer(serverId, options = {}) {
 ...
 */
export async function verifyMCPServer(serverId) {
    const config = getMCPServerConfig(serverId);
    if (!config) {
        return {
            serverId,
 ...
 */
export async function selectMCPServers(skipPrompt = false) {
    if (skipPrompt) {
 ...
 */
export async function installMCPServers(serverIds, options = {}) {
