...
import { createContext, getContext, removeContext, searchContext, listContext, listTags, findRelated, exportBeadsToJson, importBeadsFromJson, } from '../beads/context-store.js';
...
export function createContextCommand() {
    ...
    context
        ...
        const scope = context.opts().global ? 'global' : 'project';
 ...
 */
function displayBeadSummary(bead) {
 ...
 */
function formatContextAsPrompt(beads, options) {
    const lines = [];
 ...
 */
function formatContextAsMarkdown(beads, _options) {
    const lines = [];
