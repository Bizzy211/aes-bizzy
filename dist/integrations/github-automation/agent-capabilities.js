 ...
 */
export const LABEL_SPECIALIZATION_MAP = {
    bug: ['debugging'],
 ...
 */
function determineSpecializations(description, keywords) {
 ...
 */
export async function loadAgentCapabilities(agentsDir, forceReload = false) {
    // Check cache
 ...
 */
export async function getAgentCapability(agentName, agentsDir) {
 ...
 */
export async function findAgentsByKeywords(keywords, agentsDir) {
    const capabilities = await loadAgentCapabilities(agentsDir);
 ...
 */
export async function findAgentsBySpecialization(specialization, agentsDir) {
    const capabilities = await loadAgentCapabilities(agentsDir);
    const matches = [];
 ...
 */
export async function getAvailableAgents(agentsDir) {
    const capabilities = await loadAgentCapabilities(agentsDir);
 ...
 */
export async function buildCapabilityMap(agentsDir) {
    const capabilities = await loadAgentCapabilities(agentsDir);
    const map = {};
    for (const [name, capability] of capabilities) {
        map[name] = capability;
