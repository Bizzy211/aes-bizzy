 ...
 */
export const COMPONENT_TYPES: ComponentType[] = ['agents', 'hooks', 'skills', 'scripts', 'slash-commands'];

/**
 * Mapping of component types to directories
 */
export const COMPONENT_DIRS: Record<ComponentType, string> = {
  agents: 'agents',
  hooks: 'hooks',
  skills: 'skills',
  scripts: 'scripts',
 ...
 */
export const MANIFEST_PATHS: Record<ManifestTier, string> = {
